...
"How well can an archetype write code?"
What's new in v2
Featurev1v2Agent edits train.py✓✓Fixed 5-min budget✓✓Hypothesis tracking✗✓Dead zone detection✗✓Exploration/exploitation balance✗✓Meta-researcher rewrites program.md✗✓program.md version history✗✓
Architecture
┌─────────────────────────────────────────────────────┐
│                    AGENT 1: Researcher               │
│                                                      │
...
program_history/      ← program.md version archive (auto-generated)
  ...
  ...
Installation
bash# 1. Clone the original autoresearch
...
tsvcommit	val_bpb	memory_gb	status	type	hypothesis_id	description
...
tsvversion	experiments_analyzed	trend	explore_ratio	dead_zones_unlocked	hypotheses_added	program_changed	summary	timestamp
